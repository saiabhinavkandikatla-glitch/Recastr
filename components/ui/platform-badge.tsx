...
const platformClass: Record<Platform, string> = {
  ...
  HOOKS: "bg-orange-500/10 text-orange-700 ring-orange-500/20 dark:text-orange-300",
  CTA: "bg-indigo-500/10 text-indigo-700 ring-indigo-500/20 dark:text-indigo-300",
};
